...
<main class="container mt-3" >
    ...
    <div class="row detail-div mt-3">
      ...
      <div class="col-sm-7 order-sm-2 order-1">
        ...
        <div id="button" style="margin-top: 20px;">
          <button id="btn-add-cart" type="button" class="btn btn-success btn-cart" style="margin-right: 15px;"><a style="color:white;text-decoration:none" href="add-to-cart?id=${o.id}">Thêm vào giỏ hàng</a></button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="detail-content" style="font-size: 18px;">${detail.script}</div>
  <hr>
            ...
            <form action="/addComment" method="post">
              <div class="bg-light p-2">
                <div class="d-flex flex-row align-items-start">
                  <img class="rounded-circle" src="${sessionScope.acc.avatar}" width="40">
                  <textarea placeholder=" Nhận Xét" cols="10" rows="8" class="form-control ml-1 shadow-none textarea" name="comment"></textarea>
                </div>
          ...
          <c:forEach items="${cmt}" var="a">
            <div  style='margin-left: 30px;display: flex;margin-top: 10px;margin-bottom:10px;'>
              <div style="margin-top:0px;margin-right: 10px;font-size: 30px;">
                <img class="rounded-circle" src="${a.avatar}" width="40">
              </div>
              <div style="border-radius: 10px;background-color:bisque">
                <span style="margin-left:10px;margin-right:10px;font-size:25px;font-weight:650;">${a.username}</span><br>
                <p style="margin-left:10px;margin-right:10px;font-size:17px; font-weight:400">${a.comment}</p>
              </div>
            </div>
<%--      class="bg-white p-2">
